...
<head>
    ...
    <title>appAgenda-Remover Contato</title>
...
<body>
        ...
        <nav id="menu">
            ...
            <div id="contentMenu">
                <ul class="menu">
                    ...
                    <li class="link"><a href="removeContato.php#contato">CONTATO</a></li>
    ...
    <main>
        <div id="container">
            <img src="../img/remover.PNG" alt="Adicionar" width="100px" height="100px">
